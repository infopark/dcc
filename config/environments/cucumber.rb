...
config.gem 'rspec',            :lib => false, :version => '~>1.3' unless File.directory?(File.join(Rails.root, 'vendor/plugins/rspec'))
config.gem 'rspec-rails',      :lib => false, :version => '~>1.3' unless File.directory?(File.join(Rails.root, 'vendor/plugins/rspec-rails'))
